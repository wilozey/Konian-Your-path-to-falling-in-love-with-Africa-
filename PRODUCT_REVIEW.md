# Konian Product Review

## Current Position

Konian is strongest as a Côte d'Ivoire-first, bilingual travel companion. The competitive advantage is not being another broad marketplace; it is trust, cultural specificity, local guide quality, and itinerary intelligence for one country before expanding.

## Highest-Impact Priorities

1. Trust and safety
   - Verify guides before publishing.
   - Show cancellation, meeting point, emergency contact, and language support on every experience.
   - Add post-booking trip notes and guide confirmation status.

2. Bilingual experience
   - French and English should be available across discovery, planning, booking, and support.
   - Let travellers filter by language.
   - Keep copy plain in product flows and more editorial in marketing sections.
...
- Added language filtering and sorting to discovery.
- Added trust badges to experience cards.
- Added trust and safety proof to the home page.
...
- Saved itinerary sharing.
- Offline trip notes for premium users.
